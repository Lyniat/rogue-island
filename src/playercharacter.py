...
OIgnore the Pain:   You sometimes feel the damage of an attack over 5 rounds instead of instantly. If you already suffer
                    damage over time, you forget the old "pain".
Ram:                You use your massive physical form to overpower your foes.
                    Your vitality now increases your damage by 1 per point.
Stunning:           You overwhelm your enemies with such force, that
Dungeon Basher:     You are knocking enemies back by one tile sometimes, if the block behind them is not blocked. If
...
Deflect:            You sometimes deflect incoming damage, sharing the wounds with your foe.
